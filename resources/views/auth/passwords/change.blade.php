<x-guest-layout>
    ...
    <div>
        <p class="text-center py-2 my-3 bg-theme-main text-white">パスワード変更画面</p>
        <form method="POST" action="{{ route('password.change.update') }}">
            ...
            <button type="submit" class="btn bg-theme-pink text-white text-center rounded-lg py-2 w-full mt-3">変更</button>
        </form>
    </div>
</x-guest-layout>